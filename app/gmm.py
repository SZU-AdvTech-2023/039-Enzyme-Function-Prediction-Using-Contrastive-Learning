...
dist_map = pickle.load(open('./data/distance_map/split10.pkl', 'rb'))
...
for i in range(40):
    ...
    pickle.dump(main_GMM, open('./gmm_test/GMM_10_500_' + str(i) + '.pkl', 'wb'))

    plt.hist(all_distance, bins = 500, alpha = 0.05)
    plt.savefig('./gmm_test/GMM_10_500_' + str(i) + '.png')